...
# Please use python-2 and install other dependencies from https://github.com/arne-cl/discoursegraphs
...
class RSTGraph(DiscourseDocumentGraph):
    ...
    def __init__(self, rs3_filepath=None, name=None, namespace='rst',
                 tokenize=True, precedence=False, iso='utf-8'):
        """
        ...
        utf8_parser = etree.XMLParser(encoding=iso, ns_clean=True, recover=True)
